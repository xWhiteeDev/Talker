  ...
  return (
    <>
      ...
      <div className={style.feedContainer}>
        <div className={style.addPostContainer}>
          {!focusedInput && (
            <div className={style.addPost}>
              <Button
                text="+"
                additionalStyle={{ marginLeft: "2%", border: "none",fontSize:"2rem",width:"11%",textAlign:'center' ,aspectRatio:"1/1", background:'none', color:"#000000"}}
              />
              <Input
        ...
        {focusedInput && <PostCreator stateControllerFuction={setInputFocused} />}
      </div>
    </>
  );
}
