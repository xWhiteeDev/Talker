...
import { commentReactionController, postReactionController } from '../../loader/dependencyLoader.js';
...
commentReactionRouter.post('/', isAccessTokenActive(), async (req, res, next) => {

  await commentReactionController.createReaction(req, res, next);
});

commentReactionRouter.delete('/', isAccessTokenActive(), async (req, res, next) => {

  await commentReactionController.deleteReaction(req, res, next);
});
